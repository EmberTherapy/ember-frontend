...
export async function getFlagsPanelData(client_id: string) {
...
export async function isFlagged(client_id: string) {
    const body = { "client_id": client_id };
...
export async function resolveFlags(client_id: string) {
    const body = { "client_id": client_id };
