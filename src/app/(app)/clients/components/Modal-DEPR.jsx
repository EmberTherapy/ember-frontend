...
// export default function Modal({ mode, onCloseModal, onOpenModal, onEarlyClose, clientId, recordId, onDeleteRecord }) {
...
//                 {isRecordWriteMode && <WriteRecordModal mode={mode} clientId={clientId} recordId={recordId} onCloseModal={onCloseModal} onEarlyClose={onEarlyClose} onDeleteRecord={onDeleteRecord} />}
//             </div>
//         </div>
//     );
// }
